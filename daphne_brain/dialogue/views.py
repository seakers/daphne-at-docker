    ...
    def post(self, request, format=None):
        ...
        try:
            ...
            ##################################################################################################################
                ...
                IMAGES_PATH = "/usr/src/app/daphne-at-interface/src/images"
                image_path = os.path.join(IMAGES_PATH, f"{image_name}.png")
                encoded_file_path = urllib.parse.quote(image_name + ".png", safe="")
                image_link = f"{base_url}/images/{encoded_file_path}"
                print("-------------------------> encoded file path", image_path, encoded_file_path)
                ...
                # image_link = f"{base_url}/api/at/recommendation/figure?filename=%2F{encoded_file_path}"
