...
# NOTE: Probabilities for parameters based on the state of their temporal priors (t-1) and spatial neighbors (L1) 
# are added under ALL anomalies and those measured seperately in (L2), respectively. This reflects a massive expansion
...
# NOTE: Experimenting with setting what is currently 'No Anomalies Present' to be 'Unknown Anomaly'
# # ADDED ON 02/23/2026
# def add_unknown_anomaly_probabilities(probability_dict, measurement_ranges):
#     new_entries = {} # create an empty dictionary for unknown anomaly probabilities
    
#     state_names = ["Exceeds_UpperWarningLimit", "Exceeds_UpperCautionLimit", "Nominal",
#                    "Exceeds_LowerCautionLimit", "Exceeds_LowerWarningLimit"]

#     off_nominal_prob = 0.9
#     n_off = len(state_names) - 1
#     # alpha = 0.8 # may need to update if effect too strong
#     for parameter, anomalies in probability_dict.items():
#         # Add Unknown for the base parameter
#         unknown_distribution = {
#             True: {},
#             False: {}
#         }

#         # Assign probabilities for Unknown=True
#         for state in state_names:
#             if state == "Nominal":
#                 unknown_distribution[True][state] = 1 - off_nominal_prob
#             else:
#                 unknown_distribution[True][state] = off_nominal_prob / n_off

#         unknown_distribution[False]['Exceeds_UpperWarningLimit'] = 0.0001
#         unknown_distribution[False]['Exceeds_UpperCautionLimit'] = 0.001
#         unknown_distribution[False]['Nominal'] = 0.9978
#         unknown_distribution[False]['Exceeds_LowerCautionLimit'] = 0.001
#         unknown_distribution[False]['Exceeds_LowerWarningLimit'] = 0.0001
#         # print('Unknown distribution:', unknown_distribution)

#         # Insert Unknown into the anomaly dictionary for this parameter
#         anomalies["Unknown Anomaly"] = {
#             'probabilities': unknown_distribution,
#             'value_ranges': measurement_ranges.get(parameter, None)
#         }
#     # Update the probability dictionary with new unknown anomaly probabilities
#     probability_dict.update(new_entries)

# # Add unknown anomaly probabilities to dictionary
# add_unknown_anomaly_probabilities(probability_dict, measurement_ranges)
...
output_file_path = os.path.join(current_dir, "ex_split_probability_dict.json")
