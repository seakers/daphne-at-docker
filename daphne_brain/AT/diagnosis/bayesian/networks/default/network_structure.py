...
network = [
    ...
    ("PDU 4 Failure", "high 2-butanone"), ("PDU 4 Failure", "high 2-butanone (t-1)"), 
    ("PDU 4 Failure", "high Acetaldehyde"), ("PDU 4 Failure", "high Acetaldehyde (t-1)"),
    ("PDU 4 Failure", "high Aux Cabin Fan #2"), ("PDU 4 Failure", "high Aux Cabin Fan #2 (t-1)"),
    ("PDU 4 Failure", "high Cabin Temperature (L1)"), ("PDU 4 Failure", "high Cabin Temperature (L1) (t-1)"),
    ("PDU 4 Failure", "high Humidity (L1)"), ("PDU 4 Failure", "high Humidity (L1) (t-1)"),
    ("PDU 4 Failure", "high Main Cabin Fan #2"), ("PDU 4 Failure", "high Main Cabin Fan #2 (t-1)"),
    ("PDU 4 Failure", "high PDU 4 Bank 1"), ("PDU 4 Failure", "high PDU 4 Bank 1 (t-1)"),
    ("PDU 4 Failure", "high Cabin Temperature (L2)"), ("PDU 4 Failure", "high Cabin Temperature (L2) (t-1)"),
    ("PDU 4 Failure", "high Humidity (L2)"), ("PDU 4 Failure", "high Humidity (L2) (t-1)"),
    ("PDU 4 Failure", "low 2-butanone"), ("PDU 4 Failure", "low 2-butanone (t-1)"), 
    ("PDU 4 Failure", "low Acetaldehyde"), ("PDU 4 Failure", "low Acetaldehyde (t-1)"), 
    ("PDU 4 Failure", "low Aux Cabin Fan #2"), ("PDU 4 Failure", "low Aux Cabin Fan #2 (t-1)"),
    ("PDU 4 Failure", "low Cabin Temperature (L1)"), ("PDU 4 Failure", "low Cabin Temperature (L1) (t-1)"),
    ("PDU 4 Failure", "low Humidity (L1)"), ("PDU 4 Failure", "low Humidity (L1) (t-1)"),
    ("PDU 4 Failure", "low Main Cabin Fan #2"), ("PDU 4 Failure", "low Main Cabin Fan #2 (t-1)"),
    ("PDU 4 Failure", "low PDU 4 Bank 1"), ("PDU 4 Failure", "low PDU 4 Bank 1 (t-1)"),
    ("PDU 4 Failure", "low Cabin Temperature (L2)"), ("PDU 4 Failure", "low Cabin Temperature (L2) (t-1)"),
    ("PDU 4 Failure", "low Humidity (L2)"), ("PDU 4 Failure", "low Humidity (L2) (t-1)"),
    ("PDU 4 Failure", "[HIDDEN] PDU 4 Failure Component"),

    # PDU 5 Failure
    ("PDU 5 Failure", "high 2-butanone"), ("PDU 5 Failure", "high 2-butanone (t-1)"),
    ("PDU 5 Failure", "high Acetaldehyde"), ("PDU 5 Failure", "high Acetaldehyde (t-1)"),
    ("PDU 5 Failure", "high Aux Cabin Fan #2"), ("PDU 5 Failure", "high Aux Cabin Fan #2 (t-1)"),
    ("PDU 5 Failure", "high Cabin Temperature (L1)"), ("PDU 5 Failure", "high Cabin Temperature (L1) (t-1)"),
    ("PDU 5 Failure", "high Humidity (L1)"), ("PDU 5 Failure", "high Humidity (L1) (t-1)"),
    ("PDU 5 Failure", "high Main Cabin Fan #2"), ("PDU 5 Failure", "high Main Cabin Fan #2 (t-1)"),
    ("PDU 5 Failure", "high PDU 5 Bank 1"), ("PDU 5 Failure", "high PDU 5 Bank 1 (t-1)"),
    ("PDU 5 Failure", "high Cabin Temperature (L2)"), ("PDU 5 Failure", "high Cabin Temperature (L2) (t-1)"),
    ("PDU 5 Failure", "high Humidity (L2)"), ("PDU 5 Failure", "high Humidity (L2) (t-1)"),
    ("PDU 5 Failure", "low 2-butanone"), ("PDU 5 Failure", "low 2-butanone (t-1)"),
    ("PDU 5 Failure", "low Acetaldehyde"), ("PDU 5 Failure", "low Acetaldehyde (t-1)"),
    ("PDU 5 Failure", "low Aux Cabin Fan #2"), ("PDU 5 Failure", "low Aux Cabin Fan #2 (t-1)"),
    ("PDU 5 Failure", "low Cabin Temperature (L1)"), ("PDU 5 Failure", "low Cabin Temperature (L1) (t-1)"),
    ("PDU 5 Failure", "low Humidity (L1)"), ("PDU 5 Failure", "low Humidity (L1) (t-1)"),
    ("PDU 5 Failure", "low Main Cabin Fan #2"), ("PDU 5 Failure", "low Main Cabin Fan #2 (t-1)"),
    ("PDU 5 Failure", "low PDU 5 Bank 1"), ("PDU 5 Failure", "low PDU 5 Bank 1 (t-1)"),
    ("PDU 5 Failure", "low Cabin Temperature (L2)"), ("PDU 5 Failure", "low Cabin Temperature (L2) (t-1)"),
    ("PDU 5 Failure", "low Humidity (L2)"), ("PDU 5 Failure", "low Humidity (L2) (t-1)"),
