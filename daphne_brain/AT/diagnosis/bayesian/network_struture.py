...
network = [
    ...
    # N2 Tank Burst (IHab)
    ("N2 Tank Burst (IHab)", "high ppN2_IHab (IHab)"), ("N2 Tank Burst (IHab)", "high ppN2_IHab (IHab) (t-1)"),  
    ...
    ("N2 Tank Burst (IHab)", "low ppN2_IHab (IHab)"), ("N2 Tank Burst (IHab)", "low ppN2_IHab (IHab) (t-1)"),
    ...
    # N2 Tank Burst (HALO)
    ("N2 Tank Burst (HALO)", "high ppN2_HALO (HALO)"), ("N2 Tank Burst (HALO)", "high ppN2_HALO (HALO) (t-1)"),
    ...
    ("N2 Tank Burst (HALO)", "low ppN2_HALO (HALO)"), ("N2 Tank Burst (HALO)", "low ppN2_HALO (HALO) (t-1)"),
...
temporal_nodes = [
    ...
    ("high ppN2_IHab (IHab) (t-1)", "high ppN2_IHab (IHab)"), ("low ppN2_IHab (IHab) (t-1)", "low ppN2_IHab (IHab)"),
    ("high ppN2_HALO (HALO) (t-1)", "high ppN2_HALO (HALO)"), ("low ppN2_HALO (HALO) (t-1)", "low ppN2_HALO (HALO)"),
...
spatial_nodes = [
    ...
    ("high ppN2_IHab (IHab)", "high ppN2_HALO (HALO)"), ("low ppN2_IHab (IHab)", "low ppN2_HALO (HALO)"),
