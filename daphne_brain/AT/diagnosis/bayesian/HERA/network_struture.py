...
# Updated on 09/18/2026 to revert to L1/L2 naming convention from HERA
# (as with other scripts, need to confirm whether keeping all current lelve-specific anomalies is desired)
