...
ALLOWED_HOSTS = ['localhost', '127.0.0.1', '0.0.0.0', 'daphne-at-hera-backend', 'www.selva-research.com', 'selva-research.engr.tamu.edu',
...
DATABASES = {
    'default': {
        ...
        "NAME": os.environ.get("POSTGRES_DB", "daphne"),
        "USER": os.environ.get("POSTGRES_USER","daphne"),
        "PASSWORD": os.environ.get("POSTGRES_PASSWORD","daphnetest"),
